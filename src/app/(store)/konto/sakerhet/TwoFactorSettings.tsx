...
export function TwoFactorSettings({ user }: TwoFactorSettingsProps): React.ReactElement {
  ...
  const getGracePeriodInfo = () => {
    ...
    return { remainingDays, progress, isExpired, expiresAt };
  };
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Skydda ditt konto med en extra verifieringsnivå vid inloggning
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className={gracePeriod.isExpired ? 'text-destructive' : ''}>
                  {gracePeriod.isExpired ? 'Utgången' : `${gracePeriod.remainingDays} dagar kvar`}
                </span>
              </div>
              <Progress 
          ...
          <div className="flex gap-2">
            {!user.twoFactorEnabled ? (
              <Button onClick={() => setSetupStep('password')} className="flex-1">
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="flex flex-col items-center text-center p-4 rounded-lg border">
              ...
              <h4 className="font-medium mb-1">Installera app</h4>
              <p className="text-sm text-muted-foreground">
                Ladda ner Google Authenticator eller Authy på din telefon
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4 rounded-lg border">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 mb-3">
              ...
              <h4 className="font-medium mb-1">Skanna QR-kod</h4>
              <p className="text-sm text-muted-foreground">
                Lägg till Work Safe i din autentiseringsapp
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-4 rounded-lg border">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 mb-3">
              ...
              <h4 className="font-medium mb-1">Ange kod</h4>
              <p className="text-sm text-muted-foreground">
                Vid inloggning anger du koden från appen
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              ...
              Spara dina reservkoder på en säker plats (inte på samma enhet)
            </li>
            <li className="flex items-start gap-2">
              <Check className="h-4 w-4 mt-0.5 text-green-500 shrink-0" />
              Använd ett unikt, starkt lösenord för ditt konto
            </li>
            <li className="flex items-start gap-2">
              <Check className="h-4 w-4 mt-0.5 text-green-500 shrink-0" />
            ...
            <li className="flex items-start gap-2">
              <Check className="h-4 w-4 mt-0.5 text-green-500 shrink-0" />
              Kontrollera regelbundet din kontoaktivitet
            </li>
          </ul>
        </CardContent>
      </Card>
      ...
      {/* Setup Dialog */}
      <Dialog open={setupStep !== 'idle'} onOpenChange={(open) => !open && setSetupStep('idle')}>
        {renderSetupContent()}
      </Dialog>
